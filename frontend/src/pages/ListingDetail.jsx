...
const ListingDetail = () => {
  ...
  if (error || !listing) return (
    <div className="container py-5 text-center text-muted">{error || "Listing not found."}</div>
  );
  ...
  return (
    <div className="container py-5">
      <button
        className="btn btn-link text-success p-0 mb-4 text-decoration-none fw-medium"
        onClick={() => navigate("/")}
      >
        ← Back to listings
      </button>
      ...
      <div className="row g-4">
        ...
        <div className="col-12 col-lg-7">
          <div
            className="card-img-placeholder rounded overflow-hidden d-flex align-items-center justify-content-center"
            style={{ height: 380 }}
          >
        ...
        <div className="col-12 col-lg-5">
          <div className="card border shadow-sm p-4 h-100">
            ...
            <h3 className="fw-bold mb-3 text-success">₹{listing.price}</h3>
            ...
            {isSeller ? (
              <div className="alert alert-secondary text-center small">This is your listing</div>
            ) : user ? (
              <button
              ...
              >
                {contacting && <span className="spinner-border spinner-border-sm me-2" />}
                {contacting ? "Starting chat..." : "💬 Message Seller"}
              </button>
            ) : (
              <button onClick={() => navigate("/login")} className="btn btn-outline-success w-100 py-2">
